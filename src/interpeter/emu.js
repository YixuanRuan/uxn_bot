...
// The code below is downloaded from the following link:
// https://wiki.xxiivv.com/etc/unicycle/index.html
// The github project address is:
// https://github.com/XXIIVV/oscean/tree/main/etc/unicycle

import Uxn from "./uxn.js";

const Console = function(emu)
{
	this.buffer = ""
